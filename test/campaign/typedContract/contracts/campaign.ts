...
import ABI from '../../artifacts/campaign.json';
import QueryMethods from '../query/campaign';
import BuildExtrinsicMethods from '../build-extrinsic/campaign';
import TxSignAndSendMethods from '../tx-sign-and-send/campaign';
import MixedMethods from '../mixed-methods/campaign';
import EventsClass from '../events/campaign';
